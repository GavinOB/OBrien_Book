...
\begin{Kids}
	\KidNum{}{i.}\KidName{William H.\textsuperscript{5} Rogan},\index{Rogan!William H.\textsuperscript{5}} b.\ Chelsea,\index{Massachusetts!Chelsea} Suffolk Co., Mass., 22 Jan.\ 1891;\cite{William5RoganBirth} d.\ Broward Co.,\index{Florida!Broward County} Fla., 1 Jan.\ 1963;\cite{William5RoganDeath} m.\ Manhattan,\index{New York City!Manhattan} Kings Co., N.Y., 18 Aug.\ 1918, \KidName{Irene Hickey}.\cite{William5RoganMarriage} William served in the U.S.\ Navy during WWI.\cite{William5RoganHeadstone:2}\index{Navy}\index{World War I}
	
	\KidNum{}{ii.}\KidName{Marguerite E.\ Rogan},\index{Rogan!Marguerite E.\textsuperscript{5}}\index{Shea!Marguerite E.\textsuperscript{5} (Rogan)} b. Chelsea,\index{Massachusetts!Chelsea} 28 Apr.\ 1893;\cite{Marguerite5RoganBirth} m.\ \KidName{John J.\ Shea}.\cite{Census1940Marguerite5Rogan}\index{Shea!John J.}
	
	\KidNum{}{iii.}\KidName{Abigail Josephine ``Abbie'' Rogan},\index{Rogan!Abigail Josephine\textsuperscript{5}} b.\ Chelsea,\index{Massachusetts!Chelsea} 26 Jan.\ 1898;\cite{Abigail5RoganBirth} d.\ Dedham,\index{Massachusetts!Dedham} 9 March 1960; unm.\cite{Abigail5RoganDeath}
	
	\KidNum{}{iv.}\KidName{Mary Alice Rogan},\index{Rogan!Mary Alice\textsuperscript{5}} b.\ Boston, 13 June 1904;\cite{Mary5RoganBirth} d.\ Dedham, 8 Sept.\ 1971; unm.\cite{Mary5RoganDeath}
	
	\KidNum{}{v.}\KidName{Anne Irene Rogan},\index{Rogan!Anne Irene\textsuperscript{5}}\index{Doran!Anne Irene\textsuperscript{5} (Rogan)} b.\ Boston,\index{Massachusetts!Boston} 2 Nov.\ 1907;\cite{Anne5RoganBirth} d.\ Louisville,\index{Kentucky!Louisville} Jefferson Co., Ky., 10 Dec.\ 2001;\cite{Anne5RoganDeath} m.\ \KidName{John P.\ Doran}.\cite{Census1940Anne5Rogan}\index{Doran!John P.}
\end{Kids}