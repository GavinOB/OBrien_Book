...
\begin{Kids}
	\KidNum{}{i.}\KidName{Joan\textsuperscript{5} Brady}\index{Brady!Joan\textsuperscript{5}}
	
	\KidNum{}{ii.}\KidName{Paul Brady}\index{Brady!Paul\textsuperscript{5}}
	
	\KidNum{}{iii.}\KidName{Walter Brady}\index{Brady!Walter\textsuperscript{5}}
	
	\KidNum{}{iv.}\KidName{Beatrice Brady}\index{Brady!Beatrice\textsuperscript{5}}
\end{Kids}
