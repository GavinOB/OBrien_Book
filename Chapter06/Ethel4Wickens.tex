...
\MainPerson{Ethel Mary\textsuperscript{4} Wickens}\index{Wickens!Ethel Mary\textsuperscript{4}|bb}\textsuperscript{Heuman!Ethel Mary\textsuperscript{4} (Wickens)|bb} (\Lineage{3}{Frances}, \Lineage{2}{Michael}, \Lineage{1}{William}) was born on 17 June 1902 in Boston, Suffolk County, Massachusetts.\index{Massachusetts!Boston}\cite{Ethel4WickensBirth} She died on 27 July 1967 in Macomb, Macomb County, Michigan.\index{Michigan!Macomb}\cite{Ethel4WickensDeath} She married, on 20 September 1923 in Wayne County, Michigan,\index{Michigan!Wayne County} \MainPerson{Harold Edward Heuman}.\index{Heuman!Harold Edward}\cite{Ethel4WickensMarriage} He was born on 12 May 1902 in Chicago, Cook County, Illinois\index{Illinois!Chicago}\cite{HaroldHeumanDeath,HaroldHeumanDraft} to John Heuman\index{Heuman!John} and Augusta (Martin) Heuman.\index{Heuman!Augusta (Martin)}\index{Martin!Augusta}\cite{Census1910HaroldHeuman,GraceHeumanBirth} He died in Clinton, Macomb County, Michigan,\index{Michigan!Clinton} on 10 May 1993.\cite{HaroldHeumanDeath}
...
\begin{KidsIntro}
	Children of Harold E.\ Heuman\index{Heuman!Harold Edward} and Ethel Mary\textsuperscript{4} (Wickens) Heuman:\index{Wickens!Ethel Mary\textsuperscript{4}|bb}\index{Heuman!Ethel Mary\textsuperscript{4} (Wickens)|bb}
\end{KidsIntro}
