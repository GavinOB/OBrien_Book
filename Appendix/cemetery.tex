...
\begin{table}[ht]
	\centering
		\caption{William O'Brien plot, North Cambridge Catholic Cemetery\index{North Cambridge Catholic Cemetery}\cite{DianaBerberenaLetter1:3} \\
...
\begin{table}[ht]
	\centering
	\caption{Edward O'Brien plot, Holy Cross Cemetery\index{Holy Cross Cemetery}\cite{HolyCrossPlotEdward:2} \\
...
\begin{table}[ht]
	\centering
	\caption{Michael O'Brien plot, Holy Cross Cemetery\index{Holy Cross Cemetery}\cite{HolyCrossPlotMichael} \\
		Malden, Middlesex County, Massachusetts\index{Massachusetts!Malden}\\
...
\begin{table}[ht]
	\centering
	\caption{Fernald plot, Holy Cross Cemetery\index{Holy Cross Cemetery}\cite{HolyCrossPlotFernald} \\
		Malden, Middlesex County, Massachusetts\index{Massachusetts!Malden}\\
...
\begin{table}[ht]
	\centering
	\caption{Wickens plot, Holy Cross Cemetery\index{Holy Cross Cemetery}\cite{HolyCrossPlotWickens}\\
		Malden, Middlesex County, Massachusetts\index{Massachusetts!Malden}\\
...
\begin{table}[ht]
	\centering
	\caption{John O'Brien plot, Catholic Mt.\ Auburn Cemetery\index{Catholic Mt.\ Auburn Cemetery}\cite{BillMcEvoy:5} \\
...
\begin{table}[ht]
	\centering
	\caption{Mahoney plot, Mt. Calvary Cemetery\index{Mt.\ Calvary Cemetery}\cite{John3OBrienBurial:3} \\
...
\begin{table}[ht]
	\centering
	\caption{William O'Brien plot, Mt.\ Calvary Cemetery\index{Mt.\ Calvary Cemetery}\cite{William3OBrienBurial} \\
		Boston (Roslindale), Suffolk County, Massachusetts\index{Massachusetts!Boston!Roslindale}\\
		C7-22-22}
	\begin{tabular}{|l|l|}
		\hline
...
\begin{thebibliography}{99}
		\addcontentsline{toc}{section}{Appendix \thechapter\ Citations}
