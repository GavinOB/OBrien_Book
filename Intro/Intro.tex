...
\begin{itemize}
	...
	\begin{itemize}
		\item Michael Cusick, husband of \MainPerson{Hannah\textsuperscript{3} Dooley}
		\item John B.\ Wickens, husband of \MainPerson{Frances E.\textsuperscript{3} O'Brien}
		\item John F.\ McCarthy, husband of \MainPerson{Catharine F.\textsuperscript{4} Simonds}
	\end{itemize}
